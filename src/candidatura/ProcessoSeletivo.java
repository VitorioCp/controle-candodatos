...
public class ProcessoSeletivo {
    ...
    public static void main(String[] args) {
        String[] candidatos = { "Felipe", "Vitorio", "Cleiton", "joao", "vitorinho", "malaquias", "malaquiasJr" };
    ...
    static void entrandoEmContato(String candidato) {
        ...
        if(atendeu){
            ...
            System.out.println("Não conseguimos contato com " + candidato + ", número maximo de tentativas alcançadas");
        }
    }
